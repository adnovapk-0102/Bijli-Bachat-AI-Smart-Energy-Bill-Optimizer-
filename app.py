...
[data-testid="stSidebar"] [data-testid="stNumberInput"] button {
    ...
    /* ---------------------------------------------------- */
    /* HOUSEHOLD PROFILE LIGHT-THEME CONTRAST FIX          */
    /* Targeted sidebar-only fix; layout and functionality  */
    /* remain unchanged, and the dark sidebar is preserved. */
    /* ---------------------------------------------------- */
    [data-testid="stSidebar"] input,
    ...
    /* Expanded Appliance 1/2/... controls */
    [data-testid="stSidebar"] [data-testid="stExpander"] input,
    [data-testid="stSidebar"] [data-testid="stExpander"] input:disabled,
    [data-testid="stSidebar"] [data-testid="stExpander"] [data-baseweb="select"] *,
    [data-testid="stSidebar"] [data-testid="stExpander"] [data-testid="stNumberInput"] button {
        color: #0f172a !important;
        -webkit-text-fill-color: #0f172a !important;
        opacity: 1 !important;
        visibility: visible !important;
    ...
    /* Expander title remains visible when opened */
    ...
    /* Upload button/icon must be visible without hover */
    [data-testid="stSidebar"] [data-testid="stFileUploader"] button,
    [data-testid="stSidebar"] [data-testid="stFileUploader"] button *,
